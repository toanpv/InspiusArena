...
import vn.inspius.toanpv.arena.core.ui.widget.scrollWithEfab
import vn.inspius.toanpv.arena.core.ui.widget.snackbar
import vn.inspius.toanpv.arena.match.R
import vn.inspius.toanpv.arena.match.databinding.FragmentMatchesBinding
import vn.inspius.toanpv.arena.match.ui.match.list.adapter.MatchesPreviousRecyclerViewAdapter
import vn.inspius.toanpv.arena.match.ui.match.list.adapter.MatchesUpcomingRecyclerViewAdapter
import vn.inspius.toanpv.arena.match.ui.team.TeamsSelectorFragment
import vn.inspius.toanpv.arena.match.worker.cancelRemindedNotification
import vn.inspius.toanpv.arena.match.worker.scheduleNotification
...
class MatchesFragment : Fragment() {
    ...
    private fun initView() {
        val spaceGap =
            requireContext().resources.getDimensionPixelSize(vn.inspius.toanpv.arena.core.ui.R.dimen.content_padding_normal)
        with(vb) {
