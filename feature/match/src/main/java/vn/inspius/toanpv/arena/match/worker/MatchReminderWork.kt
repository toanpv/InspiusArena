...
import vn.inspius.toanpv.arena.core.ui.vectorToBitmap
...
import vn.inspius.toanpv.arena.match.worker.MatchReminderWork.Companion.NOTIFICATION_AWAY
import vn.inspius.toanpv.arena.match.worker.MatchReminderWork.Companion.NOTIFICATION_HOME
import vn.inspius.toanpv.arena.match.worker.MatchReminderWork.Companion.NOTIFICATION_ID
import vn.inspius.toanpv.arena.match.worker.MatchReminderWork.Companion.NOTIFICATION_TIME
...
class MatchReminderWork(context: Context, val params: WorkerParameters) : Worker(context, params) {
    ...
    private fun sendNotification(id: String) {
        val intent = Intent(
            applicationContext, Class.forName("vn.inspius.toanpv.arena.MainActivity")
        ).apply {
